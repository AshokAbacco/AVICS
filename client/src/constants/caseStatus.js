...
export const CASE_STATUS_META = {
  ...
  UNDER_INVESTIGATION:    { label: 'Under Investigation',    className: 'bg-primary-50 text-primary' },
  UNDER_LEGAL_REVIEW:     { label: 'Under Legal Review',     className: 'bg-primary-50 text-primary' },
  CLAIM_PROCESSING:       { label: 'Claim Processing',       className: 'bg-blue-50 text-blue-700' },
